...
const Projects = () => {
    return (
      <div className=" bg-primary text-fontclr  py-14">
        <div className="flex flex-col items-center ">
          <p className="text-xl font-semibold text-darkBg">
            Our Latest Projects
          </p>
          <h2 className="text-3xl lg:text-5xl my-3 uppercase">Associate Partners</h2>
          <Image
          ...
          <div className="w-full lg:w-3/5">
            ...
            <div className="text-start">
              <p className="text-paraclr text-xl py-5">
                Zetta Farms, A technology-driven and process-oriented farm
                project for sustainable farming of fruits & vegetables and are
                managed by agriculture experts and skilled farmers resulting in
                high yield of better quality produce thus reviving the
                agriculture economy and bringing global food sustainability.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="relative overflow-hidden rounded-lg shadow-lg  h-[442px] project-card">
                ...
                <div className="absolute bottom-0 left-0 px-6 py-7 text-fontclr project-card-bg">
                    <div className='absolute bottom-10 left-10 '>
                        <h4 className="mb-3 text-xl font-semibold tracking-tight ">{name}</h4>
