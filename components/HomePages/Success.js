        ...
        <div className=' bg-dark text-white  px-8 lg:px-36 flex flex-col items-center justify-center   py-10'>
            ...
            <div className='flex flex-col lg:flex-row  items-center justify-between gap-5 w-full mb-10'>
                <div className="flex items-center  gap-5 w-full">
                    ...
                    <div>
                        <h3 className='text-2xl font-bold text-primary'>TOTAL INVESTMENTS</h3>
                ...
                <div className="flex items-center  gap-5 w-full">
                    <Image src={"/assets/return.svg"} alt={"success"} width={100} height={50} />
                    <div>
                ...
                <div className="flex items-center  gap-5 w-full">
                    <Image src={"/assets/TotalInvestments.svg"} alt={"success"} width={100} height={50} />
                    <div>
